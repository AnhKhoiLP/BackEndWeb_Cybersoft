...
CREATE TABLE faketube.permission
(
...
CREATE TABLE faketube.video_comment
(
...
CREATE TABLE faketube.video_like
(
...
CREATE TABLE faketube.video_type
(
...
INSERT INTO faketube.code 	
	(id		, code							, expired								) VALUES
...
INSERT INTO faketube.role
(role_id			, role_name			, list_permission	) VALUES
('1'					, 'ADMIN'				, NULL						),
('2'					, 'MOD'					, NULL						),
('3'					, 'USER'				, NULL						);

INSERT INTO faketube.users (user_id, full_name, email, avatar, pass_word, face_app_id, role_id, refresh_token) VALUES
...
INSERT INTO faketube.video (video_id, video_name, thumbnail, description, views, source, user_id, type_id) VALUES
...
INSERT INTO faketube.video_type (type_id, type_name, icon) VALUES
